...
@pytest.fixture
def client(api_token: _APIToken, fake_server_url: str) -> _BeetKeeperClient:
...
def test_client_init(client: _BeetKeeperClient, api_token: _APIToken, fake_server_url: str) -> None:
...
def test_client_no_token_session_has_no_auth(fake_server_url: str) -> None:
...
def test_post(client: _BeetKeeperClient, item: Item, mocker: MockerFixture, fake_server_url: str) -> None:
