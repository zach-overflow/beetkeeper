...
HTML Should be generated from HTML Jinja template(s) under `src/python/beetkeeper/api/static/html_templates`
...
No JavaScript beyond the vendored HTMX (`src/python/beetkeeper/api/static/js/htmx.min.js`) and the minimal inline
